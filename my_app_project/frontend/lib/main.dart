    ...
    'elements': [
      {
        ...
        'text': 'hey hi im deena im suffering for fever ',
        'color': '#000000',
        'size': 20,
        'padding': {
          'left': 8,
        ...
        'borderRadius': 13.452388218470979,
        'borderWidth': 0,
          ...
          children: [
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(13.452388218470979),
              ),
              child: Opacity(
                opacity: 1,
                child: Text(
                  'hey hi im deena im suffering for fever ',
...
class _AdminPage2State extends State<AdminPage2> {
  ...
  void _initControllers() {
    for (var el in adminPages[1]['elements']) {
      if (el['type'] == ElementType.textField) {
        _controllers[el['fieldId']] = TextEditingController();
      }
    }
          ...
          children: [
            ...
            child: Container(
              ...
              child: Opacity(
                opacity: 1,
                child: TextField(
                  controller: _controllers['field_1755864641478'],
